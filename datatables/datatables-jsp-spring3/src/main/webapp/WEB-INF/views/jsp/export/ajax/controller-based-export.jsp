...
<datatables:table id="myTableId" url="${datasource}" serverSide="true" processing="true" export="pdf" serverParams="getExtraParams">
...
<%--    <datatables:export type="xls" cssClass="btn" url="${exportXlsUrl}" /> --%>
   <datatables:export type="pdf" cssClass="btn" url="${exportPdfUrl}" method="POST" />
</datatables:table>
