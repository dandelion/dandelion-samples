...
<dandelion:assets scopes="fontawesome,dandelion-demo,jquery,bootstrap" />
            ...
            <div class="nav-collapse collapse navbar-responsive-collapse">
               <ul class="nav">
                  <li class="dropdown">
                     ...
                     <%--          <li><a href="${basicsUrl}/filtering/number-range">Using a number range</a></li> --%>
                     ...
                     <%--    <li><a href="${basicsUrl}/autowidth">Table width</a></li> --%>
