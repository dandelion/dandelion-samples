...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
      <div class="container">
         ...
         <a class="brand" href="${home}">datatables-jsp-configuration-groups</a>
         <div class="nav-collapse collapse navbar-responsive-collapse">
            <ul class="nav">
               <li><a href="${home}global-group">Global group</a></li>
               <li><a href="${home}group-overloading">Group overloading</a></li>
               <li><a href="${home}local-overloading">Local overloading</a></li>
            </ul>
