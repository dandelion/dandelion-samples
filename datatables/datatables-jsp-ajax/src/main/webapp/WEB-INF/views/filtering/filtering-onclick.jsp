...
<div class="row-fluid">
   <div class="span12">
      ...
      <datatables:table id="myTableId" url="/persons" serverSide="true" processing="true" dom="l0rtip" filterSelector="filterButton" filterClearSelector="#filterClearButton">
         ...
         <datatables:column title="Salary" name="salary" property="salary" filterable="true" filterType="number_range" filterCssClass="input-small" />
         <datatables:column title="BirthDate" name="birthDate" property="birthDate" filterable="true" filterType="date_range" renderFunction="custom-rendering,moment#toDate" filterCssClass="input-small" />
