   ...
   <div class="container">
      ...
      <div class="row-fluid row-intro">
         <div class="span12">
            ...
            <p>
               As for plugin (Scroller, FixedHeader), you can also plug-in your own extension.
            </p>
            <p>
            ...
            <ul>
               <li>First in the DataTables configuration:
                  <ul>
                     <li>the <code>sDom</code> parameter has been overriden to only display the table itself and the pagination control</li>
                     <li>the default pagination type has been changed in favour of the <i>four_button</i> one</li>
                  </ul>
               </li>
               <li>Next in the HTML markup:
                  <ul>
                     ...
                     <li>The value of all <code>data-custom-attr</code> dynamic attribute has
                        been converted to the CSS class applied on the header cell
                     </li>
                  </ul>
               </li>
      ...
      <div class="row-fluid">
         <div class="span12">
            ...
            <datatables:table id="myTableId" data="${persons}" ext="myExtension">
